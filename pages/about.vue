<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは、道内の新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するため、複製・改変が許されたオープンソースライセンスで公開されている<a href="https://stopcovid19.metro.tokyo.lg.jp/">東京都公式新型コロナウイルス対策サイト</a>の<a href="https://github.com/tokyo-metropolitan-gov/covid19">システム</a>を利用して、ICTエンジニアやデザイナーなどによって結成された「JUST道IT」が開発を行いました。<br />
      <br />
