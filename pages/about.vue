<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは、道内の新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するため、ICTエンジニアやデザイナーなどによって結成された「JUST道IT」が<a href="https://github.com/tokyo-metropolitan-gov/covid19">東京都公式 新型コロナウイルス対策サイト</a>をフォークしたものです。<br />
      <br />
